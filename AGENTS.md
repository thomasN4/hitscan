...
- Audio remains WebAudio-synthesized. All six weapons use Blender sources and checked GLB exports — the player's viewmodels and the bots' third-person mounts alike; see `docs/assets.md`. Other visuals remain procedural.
