...
- Audio remains WebAudio-synthesized. All six first-person weapons use Blender sources and checked GLB exports; see `docs/assets.md`. Other visuals remain procedural.
